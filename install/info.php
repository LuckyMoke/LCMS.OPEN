...
.head1 {background-color:#2c3e50;width:100%;font-size:36px;color:#ffffff; padding: 20px 0; text-align: center; font-family: Georgia, "Times New Roman", Times, serif; font-weight: bold; }
...
<body>
<div class="head1">{ 服务器环境信息展示工具 }</div>
<div class="head2"></div>
...
<td class="fl" style="word-break:break-all;word-wrap:break-word"><?php echo htmlentities($Info['php_ini_file']);?>
</td>
...
<td class="fl" style="word-break:break-all;word-wrap:break-word"><?php echo htmlentities(_SERVER('DOCUMENT_ROOT'));?>
</td>
<?php
...
<td class="fl"><a target='_blank' href='?<?php echo $pinfo; ?>=phpinfo'>PHPINFO详细信息</a></td>
...
<?php $up_time = sprintf('%0.6f', micro_time_float() - $up_start);?>工具版本:<?php echo $version?>&nbsp;&nbsp;&nbsp;页面执行时间 <?php echo $up_time?> 秒&nbsp;&nbsp;&nbsp;消耗内存 <?php echo memory_usage();?>
</p>
</div>
</body>
</html>
